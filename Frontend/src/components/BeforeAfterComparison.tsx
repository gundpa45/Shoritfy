...
export const BeforeAfterComparison = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-app-border">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative rounded-3xl border border-app-border overflow-hidden bg-app-surface shadow-2xl aspect-[16/9] sm:aspect-[21/9] select-none">
          
          {/* BEFORE Layer */}
          <div className="absolute inset-0 bg-app-surface flex flex-col items-center justify-center p-6 text-center">
            <div className="max-w-md space-y-4">
              ...
              <h4 className="text-xl sm:text-2xl font-bold text-app-muted font-display">
                1-Hour Uncut Widescreen Video
              </h4>
              <ul className="text-xs sm:text-sm text-app-muted space-y-2 text-left font-mono">
          ...
          {/* AFTER Layer */}
          <div
            className="absolute inset-y-0 right-0 bg-app-raised border-l-2 border-app-accent flex flex-col items-center justify-center p-6 text-center transition-all duration-75 overflow-hidden"
            style={{ width: `${100 - sliderPosition}%` }}
          >
            <div className="max-w-md space-y-4 min-w-[280px]">
              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-md bg-[#8BEAD8]/20 text-app-accent text-xs font-mono font-bold border border-app-accent/30">
                <CheckCircle2 className="w-3.5 h-3.5 text-app-accent" /> AFTER: Shortify Viral Short
              </span>
              <h4 className="text-xl sm:text-2xl font-bold text-app-text font-display">
                45-Second 9:16 Viral Masterpiece
              </h4>
              <ul className="text-xs sm:text-sm text-app-text space-y-2 text-left font-mono">
        ...
        <div className="text-center mt-3 text-xs font-mono text-app-subtle flex items-center justify-center gap-1">
          <ArrowRight className="w-3 h-3 text-app-accent" /> Drag slider left or right to compare outputs
        </div>
      </div>
